...
Patch0:        dictionary-creation.patch
...
%package voxin
Summary:        Speech Dispatcher voxin module
Requires:       %{name}%{_isa} = %{version}-%{release}
Obsoletes:      speech-dispatcher < 0.8.1-2

%description voxin
This package contains the voxin output module for Speech Dispatcher.
...
%exclude %{_sysconfdir}/speech-dispatcher/modules/ibmtts.conf
...
%files voxin
%config(noreplace) %{_sysconfdir}/speech-dispatcher/modules/ibmtts.conf
